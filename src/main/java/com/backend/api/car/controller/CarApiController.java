...
public class CarApiController {
    ...
    @GetMapping
    public ResponseEntity<List<String>> getCarModels(@RequestParam Integer year, @RequestParam String make, @RequestParam String type) throws InterruptedException {
